...
if (db_has_stock_items()) {
	...
	start_row();
	stock_items_list_cells(_('Select an item:'),null, 'stock_id', null, _('New item'), true, check_value('show_inactive'), false, array('fixed_asset' => get_post('fixed_asset'), 'search_submit'=>true));
