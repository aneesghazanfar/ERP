...
//		small_qty_cells_ex(null, 'perpc', 0,false);
		...
		$perpc =1;
		$total_req = total_req($ini_qty, $perpc, $_POST['cwaste']);
		qty_cell($total_req);
...
display_heading("Plan Dyed & Greige Fabrics Against Sales Order");
start_table(TABLESTYLE, "width='90%'");
$th = array(_('Style Id'), _('Dyed Fab Code'), _('Fabric Desc'), _('UoM'), _('Tot Sty Qty'), _('Pcs'), _('Cut Waste %'), _('Total Qty'), _('Ex Qty %'), _('Req Qty'), _('Greige Fab Code'), _('Dye Waste %'), _('Total Qty'), _('Ex Qty %'), _('Req Qty'), _('Req by'), '', '');
table_header($th);
start_row();
	$id = find_row('Edit');
	$editable_items = true;
