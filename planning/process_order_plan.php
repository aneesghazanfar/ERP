...
include($path_to_root.'/planning/includes/db/mso_plan_db.inc');
$js = '';
...
if ($Mode=='ADD_ITEM' && can_process()) {
	add_plan($order_no, $_POST['resource'], $_POST['plan_qty'], $_POST['ach_qty'], date2sql($_POST['plan_sdate']), date2sql($_POST['plan_edate']), $_POST['remarks']);
	display_notification(_('New order plan has been added'));
	$Mode = 'RESET';
}

if ($Mode=='UPDATE_ITEM' && can_process()) {
	update_plan($selected_id, $order_no, $_POST['resource'], $_POST['plan_qty'], $_POST['ach_qty'], date2sql($_POST['plan_sdate']), date2sql($_POST['plan_edate']), $_POST['remarks']);
