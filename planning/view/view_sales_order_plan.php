...
if ($SysPrefs->use_popup_windows)
	...
	display_heading(sprintf(_('View Sales Order Plan Against Sales Order #%d'),$_GET['trans_no']));
...
$perpc=1;
hidden('perpc', $perpc);
display_heading2(_('Dyed Fabric Plans'));
start_table(TABLESTYLE, "width='95%'");
$th = array(_('Style Id'), _('Dyed Fab Code'), _('Fabric Desc'), _('UoM'), _('Tot St Items'), _('Qty/Pc'), _('Cut Waste %'), _('Total Qty'), _('Ex Qty %'), _('Req Qty'), _('Req by'));
table_header($th);
...
// echo "<br>";
display_heading2(_('Greige Fabric Plan'));
start_table(TABLESTYLE, "width='95%'");
...
echo '<br>';
display_heading2(_('Accessories Plan (by Style)'));
start_table(TABLESTYLE, "width='95%'");
...
echo '<br>';
display_heading2(_('Accessories Plan (by Collection)'));
start_table(TABLESTYLE, "width='95%'");
$th = array(_('Acs Code'), _('Acs Desc'), _('UoM'), _('Tot Items'), _('Qty/Pc'), _('Waste %'),_('Total Qty'), _('Ex Qty %'), _('Req Qty'), _('Req by'),  _('Image'));
table_header($th);
	start_row();
